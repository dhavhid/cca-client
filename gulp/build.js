...
gulp.task('html', ['inject', 'partials'], function () {
    ...
    .pipe($.replace('../../bower_components/summernote/dist/font', '../styles/font/'))
    .pipe($.csso())
...
gulp.task('summernotefonts', function () {
    return gulp.src('bower_components/summernote/dist/font/*.{eot,svg,ttf,woff,woff2}')
    .pipe(gulp.dest(paths.dist + '/styles/font/'));
});

gulp.task('chosenimgs', function () {
...
gulp.task('build', ['html', 'images', 'fonts', 'fontawesome','bootstrapfonts','summernotefonts','chosenimgs','misc']);
